...
\begin{titlepage}
    ...
    \end{singlespace}
    % {\small \onehalfspacing Capacités de force du membre supérieur : fondements théoriques et reconstruction de modèles musculosquelettiques}
    ...
    \vfill
    Jury présidé par M. Marc GOUTTEFARDE \\ Membres du jury :
    \begin{table}[b]
    \centering
    \makebox[\textwidth]{%
    \small
